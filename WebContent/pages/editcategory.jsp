        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <form action="${pageContext.request.contextPath }/Category/update" onSubmit="return check(this)" method="post" >
                    <input type="text" name="id" value="${category.id}"   style="display:none">  
                        <div class="form-group input-group">
                            <span class="input-group-addon "><span class="glyphicon glyphicon-star"></span> </span>
                                <input type="text" class="form-control" placeholder="分类名称"  name="name"  value="${category.name}">
                        </div>
                        <div class="form-group input-group">
                            <span class="input-group-addon "><span class="fa fa-pencil"></span> </span>
                            <textarea class="form-control" rows="3"  placeholder="分类描述"  name="description">${category.description}</textarea>
                        </div>
                          <input type="submit" class="btn btn-outline btn-primary" value="修改">
                    </form>
                </div>
                <!-- /.col-lg-12 -->
            </div>
